...
const PRECACHE = [
  ...
  './assets/art/char_oxcart_down.png',
  './assets/art/char_oxcart_down_walk.png',
  './assets/art/char_oxcart_left.png',
  './assets/art/char_oxcart_left_walk.png',
  './assets/art/char_oxcart_up.png',
  './assets/art/char_oxcart_up_walk.png',
  ...
  './data/maps/huofang_1.json',
  './data/maps/huofang_2.json',
  './data/maps/inn.json',
  './data/maps/lamp_1.json',
  './data/maps/overworld.json',
  './data/maps/pond_1.json',
  './data/maps/pond_2.json',
  './data/maps/pond_3.json',
  './data/maps/shop.json',
  './data/maps/tomb_wanjin.json',
  './data/maps/trail_1.json',
  './data/maps/trail_2.json',
  './data/maps/trail_3.json',
  './data/maps/village.json',
  './data/maps/windgap_1.json',
  './data/maps/windgap_2.json',
  './data/maps/windgap_3.json',
  './data/party.json',
  './data/skills.json',
  './data/spells.json',
  './data/story.json',
