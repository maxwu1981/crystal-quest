...
ROLE = {
    ...
    'W': ('stone_wall',  1, 0, '砌筑墙体：城堡/庙/墓的墙', ''),
    '.': ('cave_floor',  0, 1, '毛面地：洞窟地面、矿坑巷道、盗洞', ''),
    'o': ('flagstone',   0, 1, '铺石地：厅、廊、甬道', ''),
    ',': ('carpet',      0, 1, '中轴地毯 / 圣道',
          '还差端头与转角两张，现在整条中轴都用同一张中段'),
    'f': ('floor',       0, 1, '木地板：兵房、居室', ''),
    'D': ('arch_door',   0, 0, '门洞', ''),
    'I': ('pillar',      1, 0, '廊柱', ''),
    'A': ('throne',      1, 0, '王座 / 祭坛 / 石棺',
          '三张都有了（throne / altar / sarcophagus），生成器目前只用王座，'
          '按建筑类型分派是下一步'),
    'B': ('bed',         1, 0, '床铺：兵房通铺', ''),
    'c': ('crate',       1, 0, '灶台 / 长桌 / 木箱堆',
          'stove 灶台也有了，伙房该用它而不是木箱——按房间用途分派是下一步'),
    'X': ('ore_vein',    1, 0, '矿脉 / 壁上磷光', ''),
    'R': ('rubble',      1, 0, '塌方碎石 / 封门石',
          'seal_stone 封门石也有了，墓门那块该用它——生成器区分这两者是下一步'),
