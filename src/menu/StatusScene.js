...
export class StatusScene {
  ...
  render(ctx) {
    ...
    const row = (x, list) => list.forEach(([k, v], i) => { drawText(ctx, k, x, 80 + i * LINE_H, { color: '#9aa4d8' }); drawText(ctx, String(v), x + 60, 80 + i * LINE_H, { align: 'right' }); });
